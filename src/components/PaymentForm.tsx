...
const PaymentForm = () => {
  ...
  return ( 
  <form
     className="flex flex-col gap-4" onSubmit={handleSubmit(handlePaymentForm)}>
      <div className="flex flex-col gap-1">
        ...
        type="text" 
        id="cardHolder" 
        placeholder="John Wayne" {...register("cardHolder")}/>
        {errors.cardHolder && (
      ...
      <div className="flex flex-col gap-1">
        ...
        type="text" 
        id="cardNumber" 
        placeholder="123456789123" {...register("cardNumber")}/>
        {errors.cardNumber && (
       ...
       <div className="flex flex-col gap-1">
        ...
        type="text" 
        id="cvv" 
        placeholder="123 Rue" {...register("cvv")}/>
        {errors.cvv && (
