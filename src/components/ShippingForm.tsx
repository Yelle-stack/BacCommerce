  ...
  <form
     className="flex flex-col gap-4" onSubmit={handleSubmit(handleShippingForm)}>
      <div className="flex flex-col gap-1">
        ...
        type="text" 
        id="name" 
        placeholder="John Wayne" {...register("name")}/>
        {errors.name && (
      ...
      <div className="flex flex-col gap-1">
        ...
        type="email" 
        id="email" 
        placeholder="johnwayne@gmail.com" {...register("email")}/>
        {errors.email && (
       ...
       <div className="flex flex-col gap-1">
        ...
        type="text" 
        id="phone" 
        placeholder="123456789" {...register("phone")}/>
        {errors.phone && (
       ...
       <div className="flex flex-col gap-1">
        ...
        type="text" 
        id="address" 
        placeholder="123 Rue du Bac" {...register("address")}/>
        {errors.address && (
      ...
      <div className="flex flex-col gap-1">
        ...
        type="text" 
        id="city" 
        placeholder="Paris" {...register("city")}/>
        {errors.city && (
